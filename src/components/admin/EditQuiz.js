...
import { useEditQuizMutation, useGetQuizQuery } from "../../features/quizes/quizesApi";
import {
  useGetVideosQuery
...
const EditQuiz = ({ isOpen, onRequestClose, id }) => {
  ...
  useEffect(()=>{
    ...
    setVideoId(getQuiz?.video_id);
    setOptions(getQuiz?.options);
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-2 gap-4 text-black w-[40vw] max-h-[70vh]">
